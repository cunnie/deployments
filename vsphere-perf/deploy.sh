...
for i in $(seq 1 20); do
    ...
    (export BOSH_DEPLOYMENT=dummy1; bosh deploy -n $SCRIPT_DIR/dummy1.yml -v network=LS.0.0) &
    (export BOSH_DEPLOYMENT=dummy2; bosh deploy -n $SCRIPT_DIR/dummy2.yml -v network=LS.0.0) &
    wait
